...
\input{tables/summary_table_fixed.tex}

\subsection{Najważniejsze obserwacje}
\begin{itemize}
  \item Najwyższą średnią liczbę playoutów na sekundę zaobserwowano dla konfiguracji \texttt{n\_trees=16, n\_playouts=512} (około 3.19e6 playouts/s).
